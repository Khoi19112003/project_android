...
public class Screen2_vn extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EditText editText_rePassword = findViewById(R.id.password);
                ...
                if (isWebViewVisible) {
                    ...
                    webView.setWebViewClient(new WebViewClient(){
                        ...
                        public void onPageFinished(WebView view, String url) {
                            ...
                            //view.loadUrl("javascript:document.getElementById('kc-register-form').submit()");

                            //Intent intent = new Intent(Screen2_vn.this, Screen3_vn.class);
                            //startActivity(intent);
                        }
                    });
